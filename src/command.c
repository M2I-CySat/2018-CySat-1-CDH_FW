...
void xStartUart1CommandHandling() {
    ...
    xTaskCreate( vUart1RXTask, NULL, configMINIMAL_STACK_SIZE + 100, NULL, systemPRIORITY_UART1, NULL );
}

void xStartUart2CommandHandling() {
    vConsolePrint("Starting command handling on UART2\r\n");
    xTaskCreate( vUart2RXTask, NULL, configMINIMAL_STACK_SIZE + 100, NULL, systemPRIORITY_UART2, NULL );
}
